...
func TestGetAllProduct(t *testing.T) {
	mockProductData := new(mocks.ProductDataZwei)
...
func TestDeleteProduct(t *testing.T) {
	productDataMock := &mocks.ProductDataZwei{}
	userDataMock := &mocks.UserData{}

	productService := New(productDataMock, userDataMock)
...
func TestSearchProducts(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		mockProductData.On("SearchProducts", 0, 2, searchQuery).Return(expectedProducts, nil).Once()
		mockProductData.On("CountProductBySearch", searchQuery).Return(expectedTotal, nil).Once()

		products, total, err := service.SearchProducts(0, 2, searchQuery)
	...
	t.Run("Error when fetching products", func(t *testing.T) {
		searchQuery := "Product"
		mockProductData.On("SearchProducts", 0, 2, searchQuery).Return(nil, errors.New("product not found")).Once()
	...
	t.Run("Error when counting products", func(t *testing.T) {
		...
		mockProductData.On("SearchProducts", 0, 2, searchQuery).Return(expectedProducts, nil).Once()
		mockProductData.On("CountProductBySearch", searchQuery).Return(0, errors.New("product not found")).Once()
